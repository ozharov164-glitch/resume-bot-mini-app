...
JOB_CONTEXT: dict[str, str] = {
    ...
    "повар": (
        "Тип кухни, техкарты, санитарные нормы, iiko/1С Общепит, "
        "работа на линии, скорость."
    ),
    "сварщик": (
        "НАКС/разряд, виды сварки (MIG/MAG/TIG/РДС), материалы, "
        "работа с документацией, соблюдение ТБ."
    ),
    "электрик": (
        "Группа допуска по электробезопасности, вид работ (монтаж/ремонт/обслуживание), "
        "оборудование, чтение схем."
    ),
    "медсест": (
        "Отделение/специализация, навыки (инъекции, капельницы, перевязки), "
        "ведение документации, работа с пациентами."
    ),
    "учитель": (
        "Предмет, возраст учеников, методики, работа с документами, "
        "достижения учеников если есть."
    ),
}
...
FALLBACK_SKILLS: dict[str, list[str]] = {
    ...
    "сварщ": [
        ...
        "Соблюдение ТБ", "Контроль качества шва", "Работа с документами",
    ],
    "электрик": [
        "Монтаж электропроводки", "Чтение схем", "Допуск до 1000В",
        "Ремонт оборудования", "Соблюдение ТБ", "Работа с инструментом",
    ],
}
